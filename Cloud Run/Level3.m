...
static const int subtractPerSecond = 13;
static const int subtractPerMove = 97;
static const int bestMovesBy = 7;
...
#pragma mark Line touch
            ...
            if ([n.name isEqualToString:@"linenode1" ]) {
                if (![stormCloud1 intersectsNode:emptyPlatform2] && [sun intersectsNode:emptyPlatform3] && ![stormCloud2 intersectsNode:emptyPlatform2] && ![stormCloud3 intersectsNode:emptyPlatform2]) {
                    ...
                    if ([stormCloud1 intersectsNode:emptyPlatform6] || [stormCloud2 intersectsNode:emptyPlatform6] || [stormCloud3 intersectsNode:emptyPlatform6]) {
                    ...
                    CGPoint position = CGPointMake(emptyPlatform3.position.x, emptyPlatform3.position.y + 10);
                ...
                else if ([stormCloud1 intersectsNode:emptyPlatform] && ![sun intersectsNode:emptyPlatform2] && ![stormCloud2 intersectsNode:emptyPlatform2] && ![stormCloud3 intersectsNode:emptyPlatform2]  ) {
                ...
                if ([sun intersectsNode:emptyPlatform2] && ![stormCloud1 intersectsNode:emptyPlatform6] && ![stormCloud2 intersectsNode:emptyPlatform6] && ![stormCloud3 intersectsNode:emptyPlatform6]) {
                    
                    CGPoint position = CGPointMake (emptyPlatform6.position.x, emptyPlatform6.position.y + 10);
                ...
                else if ([stormCloud1 intersectsNode:emptyPlatform2] && ![stormCloud2 intersectsNode:emptyPlatform6] && ![stormCloud3 intersectsNode:emptyPlatform6] && ![sun intersectsNode:emptyPlatform6]) {
                    [self stormMove:stormCloud1 moveTo:emptyPlatform6.position];
                ...
                else if ([stormCloud3 intersectsNode:emptyPlatform2] && ![stormCloud2 intersectsNode:emptyPlatform6] && ![stormCloud1 intersectsNode:emptyPlatform6] && ![sun intersectsNode:emptyPlatform6]) {
                ...
                else if ([stormCloud3 intersectsNode:emptyPlatform6] && ![stormCloud2 intersectsNode:emptyPlatform2] && ![stormCloud3 intersectsNode:emptyPlatform2] && ![sun intersectsNode:emptyPlatform2]) {
                ...
                else if ([stormCloud2 intersectsNode:emptyPlatform4] && ![stormCloud1 intersectsNode:emptyPlatform] && ![stormCloud3 intersectsNode:emptyPlatform] && ![sun intersectsNode:emptyPlatform]) {
                    CGPoint position = emptyPlatform.position;
                ...
                else if (sun.position.y == (emptyPlatform2.position.y + 10) && ![stormCloud2 intersectsNode:emptyPlatform2] && ![stormCloud1 intersectsNode:emptyPlatform2] && ![stormCloud3 intersectsNode:emptyPlatform2]) {
                ...
                if (sun.position.x == emptyPlatform5.position.x) {
                    _moveCount += 1;
                    _stepCount.text = [NSString stringWithFormat:@"%d", _moveCount];
...
- (void)setupLevel {
    ...
    stormCloud3 = [SKSpriteNode spriteNodeWithImageNamed:@"stormcloud"];
    ...
    emptyPlatform5 = [SKSpriteNode spriteNodeWithImageNamed:@"emptyplatform.png"];
    emptyPlatform6 = [SKSpriteNode spriteNodeWithImageNamed:@"emptyplatform.png"];
    
    introNode = [SKSpriteNode spriteNodeWithImageNamed:@"introLevel3"];
    ...
    emptyPlatform6.position = CGPointMake(self.size.width/2 + 10, self.size.height - 100);
    ...
    emptyPlatform2.position = CGPointMake(self.size.width / 2 + 10, emptyPlatform.position.y);
    ...
    emptyPlatform4.position = CGPointMake(self.size.width - 30, emptyPlatform6.position.y);
    
    emptyPlatform5.name = @"emptyplatform5";
    emptyPlatform5.scale = emptyPlatformScale;
    emptyPlatform5.position = CGPointMake(emptyPlatform2.position.x - 140, emptyPlatform2.position.y);
    
    endCloud.position = CGPointMake(emptyPlatform5.position.x + 5, emptyPlatform5.position.y - 120);
    ...
    lineNode2 = [SKSpriteNode spriteNodeWithColor:[UIColor blackColor] size:CGSizeMake(emptyPlatform.position.x - emptyPlatform2.position.x - 40, lineWidth)];
    lineNode3 = [SKSpriteNode spriteNodeWithColor:[UIColor blackColor] size:CGSizeMake(lineWidth, emptyPlatform6.position.y - emptyPlatform2.position.y - 10)];
    ...
    lineNode5 = [SKSpriteNode spriteNodeWithColor:[UIColor blackColor] size:CGSizeMake(emptyPlatform2.position.x - emptyPlatform5.position.x - 27, lineWidth)];
    lineNode6 = [SKSpriteNode spriteNodeWithColor:[UIColor blackColor] size:CGSizeMake(lineWidth, emptyPlatform5.position.y - endCloud.position.y + 20)];
    
    lineNode.position = CGPointMake(self.size.width /2, emptyPlatform3.position.y + 10);
    lineNode.alpha = 0.62;
    lineNode.anchorPoint = CGPointMake(0, 0);
    lineNode.name = @"linenode1";
    lineNode.color = [SKColor blackColor];
    
    lineNode2.position = CGPointMake(emptyPlatform2.position.x + 20, emptyPlatform2.position.y - 10);
    lineNode2.alpha = 0.62;
    lineNode2.anchorPoint = CGPointMake(0, 0);
    lineNode2.name = @"linenode2";
    lineNode2.color = [SKColor blackColor];
    
    lineNode3.position = CGPointMake(self.size.width / 2, emptyPlatform2.position.y + 15);
    lineNode3.alpha = 0.62;
    lineNode3.anchorPoint = CGPointMake(0, 0);
    lineNode3.name = @"linenode3";
    lineNode3.color = [SKColor greenColor];
    
    lineNode4.position = CGPointMake(self.size.width - 50, emptyPlatform.position.y - 10);
    lineNode4.alpha = 0.62;
    lineNode4.anchorPoint = CGPointMake(0, 0);
    lineNode4.color = [SKColor greenColor];
    lineNode4.name = @"linenode4";
    
    lineNode5.position = CGPointMake(emptyPlatform5.position.x + 16, emptyPlatform5.position.y - 10);
    lineNode5.alpha = 0.62;
    lineNode5.anchorPoint = CGPointMake(0,0);
    lineNode5.name = @"linenode5";
    
    lineNode6.position = CGPointMake(endCloud.position.x - 15, endCloud.position.y);
...
- (void)sunMove:(SKSpriteNode*)node moveTo:(CGPoint)position {
    ...
    SKAction *moveTo = [SKAction moveTo:CGPointMake(position.x, position.y - 15) duration:sunSpeed];
    SKAction *bounce = [SKAction scaleTo:sunBounce duration:.1];
...
- (void)stormMove:(SKSpriteNode*)node moveTo:(CGPoint)position {
    ...
    SKAction *move = [SKAction moveTo:CGPointMake(position.x, position.y - 10) duration:.4];
...
- (void)runWinScene {
    ...
    if (![GameData sharedGameData].level3HighScore) {
        [GameData sharedGameData].level3HighScore = scoreTotal;
        [[GameData sharedGameData]save];
    }
    
    if ([GameData sharedGameData].level3HighScore) {
        if (scoreTotal > [GameData sharedGameData].level3HighScore) {
            [GameData sharedGameData].level3HighScore = scoreTotal;
            [[GameData sharedGameData]save];
        }
    }
    ...
    _highScore.text = [NSString stringWithFormat:@"%ld", [GameData sharedGameData].level3HighScore];
